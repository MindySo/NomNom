...
public class MealFood {
	 private Integer mealFoodNo;
		...
		public MealFood(Integer mealFoodNo, Integer mealNo, Integer foodNo, Integer foodAmount, Double calories,
				Double carbohydrates, Double protein, Double fat, Double saturatedFat, Double unsaturatedFat,
				Double cholesterol, Double sodium, Double sugar, Double calcium, Double vitamin, Double iron,
				Double mineral) {
		...
		public String toString() {
			return "MealFood [mealFoodNo=" + mealFoodNo + ", mealNo=" + mealNo + ", foodNo=" + foodNo + ", foodAmount="
					+ foodAmount + ", calories=" + calories + ", carbohydrates=" + carbohydrates + ", protein="
					+ protein + ", fat=" + fat + ", saturatedFat=" + saturatedFat + ", unsaturatedFat=" + unsaturatedFat
					+ ", cholesterol=" + cholesterol + ", sodium=" + sodium + ", sugar=" + sugar + ", calcium="
					+ calcium + ", vitamin=" + vitamin + ", iron=" + iron + ", mineral=" + mineral + "]";
		}
}
