...
async function fetchAllReports() {
  ...
  await Promise.all([reportStore.fetchDayReport(userNo, selectedDate.value), reportStore.fetchWeeklyReport(userNo), reportStore.fetchMonthlyReport(userNo)]);
...
function getImagePath(index) {
  return new URL(`@/assets/images/meal/mealList/place-image-here${index % 3}.png`, import.meta.url).href;
}
...
async function requestDayReport() {
  chartRender.drawDoughnutCharts(calorieChart.value, reportStore.dayReport.energy, " Kcal", nutritionStore.calorieGoal, "#EF5E5E");
  chartRender.drawDoughnutCharts(waterChart.value, reportStore.dayReport.water, " ml", nutritionStore.waterGoal, "#9cd9ff");

  chartRender.drawBarCharts(dailyCarbChart.value, "탄수화물", reportStore.dayReport.carbohydrate, nutritionStore.carbGoal, "#a8e063");
  chartRender.drawBarCharts(dailyProteinChart.value, "단백질", reportStore.dayReport.protein, nutritionStore.proteinGoal, "#ffa751");
  chartRender.drawBarCharts(dailyFatChart.value, "지방", reportStore.dayReport.totalFattyAcids, nutritionStore.fatGoal, "#f9d423");
}
...
<template>
      ...
      <div class="content">
        ...
        <div class="body">
          <div class="widget-all-menu">
            <div class="date-schedulecnt">
              ...
              <!-- 날짜 선택 -->
              <div class="frame-13">
                <img class="chevron-left" src="@/assets/images/meal/mealList/chevron-left0.svg" @click="changeDate(-1)" />

                <input type="date" v-model="selectedDate" class="date-input" />

                <img class="chevron-right" src="@/assets/images/meal/mealList/chevron-right0.svg" @click="changeDate(1)" />
              </div>
              <div class="frame-17">
                <button class="button2" @click="openWaterModal">
                  <div class="icon-left">
                    <img class="icon-special-drop" src="@/assets/images/meal/mealList/icon-special-drop0.svg" />
                  </div>
                  <div class="text5">
                ...
                <button class="button3" @click="openMealModal">
                  <div class="icon-left">
                    <img class="icon-nav-fork-knife" src="@/assets/images/meal/mealList/icon-nav-fork-knife0.svg" />
                  </div>
                  <div class="text5">
                  ...
                  <div class="card-list-all-menu">
                    <div class="main-content">
                      ...
                      <div class="nutrition-info">
                        <div class="info-cal">
                          <img class="icon-special-drop2" src="@/assets/images/meal/mealList/icon-special-drop1.svg" />
                          <div class="value">
                            <div class="amount">{{ reportStore.dayReport.water }}ml</div>
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  <div v-for="(meal, index) in reportStore.meals" :key="meal.mealNo" class="card-list-all-menu2" @click="openDetailModal">
                    ...
                    <div class="main-content2">
                      ...
                      <div class="nutrition-info2">
                        <div class="info-cal">
                          <img class="icon-special-fire" src="@/assets/images/meal/mealList/icon-special-fire0.svg" />
                          <div class="value2">
                            <div class="amount">{{ meal.energy }} kcal</div>
                          </div>
                        </div>

                        <img class="separator" src="@/assets/images/meal/mealList/separator0.svg" />

                        <div class="info-carbs">
                          <img class="icon-special-bread" src="@/assets/images/meal/mealList/icon-special-bread0.svg" />
                          <div class="value">
                        ...
                        <img class="separator2" src="@/assets/images/meal/mealList/separator1.svg" />

                        <div class="info-protein">
                          <img class="icon-special-fish" src="@/assets/images/meal/mealList/icon-special-fish0.svg" />
                          <div class="value">
                        ...
                        <img class="separator3" src="@/assets/images/meal/mealList/separator2.svg" />

                        <div class="info-fats">
                          <img class="icon-special-drop3" src="@/assets/images/meal/mealList/icon-special-drop2.svg" />
                          <div class="value">
                      ...
                      <div class="frame-14">
                        <div class="group-15">
                          <div class="frame-142">
                            ...
                            <div class="title6">{{ reportStore.dayReport.carbohydrate }} g</div>
                          </div>
                          <div class="menu-nav3">
                            <canvas class="chart-bar" ref="dailyCarbChart" style="width: 100%"></canvas>
                          </div>
                        </div>
                        <div class="frame-134">
                          <div class="frame-135">
                            <div class="title7">당류</div>
                            <div class="title7">{{ reportStore.dayReport.sugar }} g</div>
                          </div>
                          <div class="frame-143">
                            <div class="title7">식이섬유</div>
                            <div class="title7">{{ reportStore.dayReport.dietaryFiber }} g</div>
                          </div>
                        </div>
                      </div>
                      <div class="frame-14">
                        <div class="group-15">
                          <div class="frame-142">
                            ...
                            <div class="title6">{{ reportStore.dayReport.protein }} g</div>
                          </div>
                          <div class="menu-nav3">
                            <canvas class="chart-bar" ref="dailyProteinChart" style="width: 100%"></canvas>
                          </div>
                        </div>
                        <div class="frame-134">
                          <div class="frame-135">
                            <div class="title7">회분</div>
                            <div class="title7">{{ reportStore.dayReport.ash }} g</div>
                          </div>
                        </div>
                      </div>
                      <div class="frame-163">
                        <div class="group-15">
                          <div class="frame-142">
                            ...
                            <div class="title6">{{ reportStore.dayReport.totalFattyAcids }} g</div>
                          </div>
                          <div class="menu-nav3">
                            <canvas class="chart-bar" ref="dailyFatChart" style="width: 100%"></canvas>
                          </div>
                        </div>
                        <div class="frame-134">
                          <div class="frame-135">
                            <div class="title7">포화지방</div>
                            <div class="title7">{{ reportStore.dayReport.saturatedFats }} g</div>
                          </div>
                          <div class="frame-143">
                            <div class="title7">불포화지방</div>
                            <div class="title7">{{ reportStore.dayReport.unsaturatedFats }} g</div>
                          </div>
                        </div>
                      </div>
                    </div>
                      ...
                      <div class="frame-19">
                        ...
                        <div class="frame-137">
                          <div class="frame-135">
                            ...
                            <div class="title7">{{ reportStore.dayReport.vitaminACarotene }} µg</div>
                          </div>
                          <div class="frame-18">
                            <div class="title7">비타민 B1 티아민</div>
                            <div class="title7">{{ reportStore.dayReport.vitaminB1 }} mg</div>
                          </div>
                          <div class="frame-192">
                            <div class="title7">비타민 B2 리보플라빈</div>
                            <div class="title7">{{ reportStore.dayReport.vitaminB2 }} mg</div>
                          </div>
                          <div class="frame-20">
                            <div class="title7">비타민 B3 니아신</div>
                            <div class="title7">{{ reportStore.dayReport.niacin }} mg</div>
                          </div>
                          <div class="frame-143">
                            <div class="title7">엽산</div>
                            <div class="title7">{{ reportStore.dayReport.folate }} µg</div>
                          </div>
                          <div class="frame-152">
                            <div class="title7">비타민 C</div>
                            <div class="title7">{{ reportStore.dayReport.vitaminC }} mg</div>
                          </div>
                          <div class="frame-164">
                            <div class="title7">비타민 D</div>
                            <div class="title7">{{ reportStore.dayReport.vitaminD }} µg</div>
                          </div>
                        </div>
                      </div>
                      <div class="frame-144">
                        <div class="frame-174">
                          ...
                          <div class="frame-137">
                            <div class="frame-135">
                              ...
                              <div class="title7">{{ reportStore.dayReport.cholesterol }} mg</div>
                            </div>
                          </div>
                        </div>
                        <div class="frame-182">
                          ...
                          <div class="frame-137">
                            <div class="frame-135">
                              ...
                              <div class="title7">{{ reportStore.dayReport.sodium }} mg</div>
                            </div>
                            <div class="frame-143">
                              <div class="title7">칼슘</div>
                              <div class="title7">{{ reportStore.dayReport.calcium }} mg</div>
                            </div>
                            <div class="frame-152">
                              <div class="title7">철</div>
                              <div class="title7">{{ reportStore.dayReport.iron }} mg</div>
                            </div>
                            <div class="frame-164">
                              <div class="title7">인</div>
                              <div class="title7">{{ reportStore.dayReport.phosphorus }} mg</div>
                            </div>
                            <div class="frame-175">
                              <div class="title7">칼륨</div>
                              <div class="title7">{{ reportStore.dayReport.potassium }} mg</div>
                            </div>
                          </div>
                        </div>
                      </div>
          ...
          <div class="content2">
            <div class="menu-nav4">
              <!-- 주간 리포트 버튼 -->
              <button :class="selectedTab === 'weekly' ? 'button-nav6' : 'button-nav9'" @click="selectedTab = 'weekly'">
                <div :class="selectedTab === 'weekly' ? 'label4' : 'label5'">주간 리포트</div>
              </button>

              <!-- 월간 리포트 버튼 -->
              <button :class="selectedTab === 'monthly' ? 'button-nav6' : 'button-nav9'" @click="selectedTab = 'monthly'">
                <div :class="selectedTab === 'monthly' ? 'label4' : 'label5'">월간 리포트</div>
              </button>
            </div>
            <div class="frame-11">
              ...
              <div class="monthly-summary" v-else-if="selectedTab === 'monthly'">
                <MonthlyReport />
              </div>
            </div>
          </div>
        ...
        <div class="section-footer">
          ...
          <div class="social-media">
            <img class="facebook-logo" src="@/assets/images/meal/mealList/facebook-logo0.svg" />
            <img class="twitter-logo" src="@/assets/images/meal/mealList/twitter-logo0.svg" />
            <img class="instagram-logo" src="@/assets/images/meal/mealList/instagram-logo0.svg" />
            <img class="youtube-logo" src="@/assets/images/meal/mealList/youtube-logo0.svg" />
            <img class="linkedin-logo" src="@/assets/images/meal/mealList/linkedin-logo0.svg" />
          </div>
        </div>
      </div>
    </div>
  ...
  <!-- 식단 추가 모달 -->
  <RegisterMealModal :show="showMealModal" @close="showMealModal = false" @mealRegistered="onWaterOrMealRegistered" />
