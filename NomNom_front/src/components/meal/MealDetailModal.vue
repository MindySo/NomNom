              ...
              <div class="frame-202">
                <div class="frame-12">
                  <div
                    ...
                    v-for="(food, index) in meal.foodList"
                    :key="index"
                  >
                    <div class="frame-122">
                      <div class="frame-123">
              ...
              <div class="detail-frame-14">
                <div class="detail-group-15">
                  <div class="detail-frame-142">
                    ...
                    <div class="detail-title6">
                      {{ meal.totalFattyAcids }} g
                    </div>
                  </div>
                  <div class="detail-menu-nav3">
                    <canvas
