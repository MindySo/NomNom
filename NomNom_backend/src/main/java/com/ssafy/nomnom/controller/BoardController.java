...
public class BoardController {
	...
	// 유저별 조회
	@GetMapping("/my-posts")
	public ResponseEntity<List<Board>> getMyBoards(@RequestParam int userNo) {
	...
	public ResponseEntity<?> deleteBoard(@PathVariable int boardNo, @RequestParam int userNo) {
